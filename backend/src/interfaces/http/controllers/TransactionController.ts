...
export default class TransactionController {
  ...
  constructor({ createTransaction, approveTransaction, rejectTransaction, completePayment, getTransactions, getTransaction, transactionRepository }: any) {
  ...
  async commissionSummary(req: any, res: any) {
    ...
    // Branch: only their own collection branch; head office: all branches
    const collectionBranchId = req.user.role === 'branch' ? req.user.branchId : undefined;
  ...
  async commissionDetail(req: any, res: any) {
    ...
    const collectionBranchId = req.user.role === 'branch' ? req.user.branchId : (branchId || undefined);
